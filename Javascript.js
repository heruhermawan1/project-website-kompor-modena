...
contactForm?.addEventListener('submit', (event) => {
    ...
    const whatsappNumber = 'Halo saya ${name}
Email: ${email}
...
const animateOnScroll = () => {
  ...
  // Pilih semua elemet yang ingin dianimasikan
  const elementsToAnimate = document.querySelectorAll(`
    .hero-copy, .hero-card, .hero-Stats, .hero-action,
    .trust-item, .feature-card, .peoduct-card, .journey-card,
    .highlight-card, .gallery-card, .testimonial-card, .faq-card,
    .section-heading, .contact-card, .vidio-wrap
`);
